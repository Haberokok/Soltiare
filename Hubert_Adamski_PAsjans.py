...
Cel: Ułóż wszystkie karty na górze, od Asa do Króla, według koloru.
Masz 7 stosów kart. Odkrywasz je i przenosisz karty.
Karty na stosach muszą być na przemian: czerwona na czarną, czarna na czerwoną, i o jeden mniejszą wartość.
Puste miejsce na stosie może zająć tylko Król.

Poziomy trudności:
- Łatwy: Dobierasz 1 kartę ze stosu rezerwy. Nieograniczone przejścia talii.
- Średni: Dobierasz 3 karty. Nieograniczone przejścia talii. Tylko wierzchnia z trzech jest od razu grywalna.
- Trudny: Dobierasz 3 karty. Tylko 1 pełne przejście talii.
""")
